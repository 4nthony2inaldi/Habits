  ...
  return useMutation({
    mutationFn: async ({
      ...
      const entryData: DailyEntryInsert = {
        ...
        city_wake_lat: data.city_wake_lat,
        city_wake_lng: data.city_wake_lng,
        miles_wake: data.miles_wake,
        city_noon: data.city_noon,
        city_noon_lat: data.city_noon_lat,
        city_noon_lng: data.city_noon_lng,
        miles_noon: data.miles_noon,
        city_sleep: data.city_sleep,
        city_sleep_lat: data.city_sleep_lat,
        city_sleep_lng: data.city_sleep_lng,
        miles_sleep: data.miles_sleep,
        // Weather data
        weather_temperature_high: data.weather_temperature_high,
        weather_temperature_low: data.weather_temperature_low,
